...
<!--        php code for add post will go here-->
    ...
    if($cat_id == "" || $title == "" || $body == "" || $author == "" || $tags == "" || $file_name == "" )
    {
    ...
    $sql = "INSERT INTO tbl_post(cat_id, title, body, image, author, tags, userid) 
    VALUES('$cat_id', '$title', '$body', '$upload_image', '$author', '$tags', '$userid')";
